...
RUN wget -q -O checkm_data.tar.gz https://data.ace.uq.edu.au/public/CheckM_databases/checkm_data_2015_01_16.tar.gz &&  tar -zxvf checkm_data.tar.gz && rm checkm_data.tar.gz && bash && source activate ha_py27 && printf '/data' | checkm data setRoot
