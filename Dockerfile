...
RUN wget -q -O checkm_data.tar.gz https://data.ace.uq.edu.au/public/CheckM_databases/checkm_data_2016_01_16.tar.gz &&  tar -zxvf checkm_data.tar.gz && rm checkm_data.tar.gz && source activate ha_py27 && checkm_db="/data" &&  echo ${checkm_db} | checkm data setRoot ${checkm_db}
